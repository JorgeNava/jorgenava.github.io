...
const BLOBS = [
  { x: 0.15, y: 0.2,  r: 0.75, color: "rgba(80,20,160,0.28)",  sx: 0.00011, sy: 0.00008, px: 0,   py: 0.7 },
  { x: 0.82, y: 0.15, r: 0.68, color: "rgba(30,10,110,0.22)",  sx: 0.00009, sy: 0.00011, px: 1.4, py: 1.1 },
  { x: 0.5,  y: 0.78, r: 0.72, color: "rgba(45,15,130,0.20)",  sx: 0.00008, sy: 0.00013, px: 2.7, py: 1.9 },
  { x: 0.78, y: 0.72, r: 0.60, color: "rgba(196,153,95,0.08)", sx: 0.00013, sy: 0.00009, px: 4.0, py: 2.6 },
  { x: 0.3,  y: 0.55, r: 0.58, color: "rgba(15,55,160,0.18)",  sx: 0.00010, sy: 0.00012, px: 1.8, py: 3.2 },
];
